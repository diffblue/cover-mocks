...
/**
 * A mock implementation of {@link ResultSet} that provides basic functionality for testing
 * purposes.
 */
public class MockResultSet implements ResultSet {
  ...
  public int getInt(String columnLabel) throws SQLException {
    return (Integer) currentRow.get(columnLabel);
  }
  ...
  public BigDecimal getBigDecimal(String columnLabel, int scale) throws SQLException {
    return ((BigDecimal) currentRow.get(columnLabel)).setScale(scale);
  }
  ...
  public java.sql.Date getDate(String columnLabel) throws SQLException {
    return (java.sql.Date) currentRow.get(columnLabel);
  }
  ...
  public ResultSetMetaData getMetaData() throws SQLException {
    return new MockResultSetMetaData(new ArrayList<>(currentRow.keySet()));
  }
  ...
  public void updateNull(String columnLabel) throws SQLException {
    currentRow.put(columnLabel, null);
  }
